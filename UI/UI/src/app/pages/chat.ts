...
export class ChatComponent implements OnInit, AfterViewChecked {
  ...
  // 2026-04-27: useTool() and TOOL_EXAMPLES removed along with the four
  // capability cards (SQL Queries / ML Predictions / Customer Profiles /
  // Risk Analysis) in chat.html. The "Try asking" suggestion chips below
  // already cover the same use cases with concrete example questions.
