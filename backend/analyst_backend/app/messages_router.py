...
DEFAULT_TEMPLATES = [
    ...
    {"id":"tpl-008","tier_name":"gold","risk_level":"new","discount_pct":5,"channel":"email","action_type":"Welcome","message_template":"Welcome to Gold, {name} - 5% off to celebrate.","priority":4,"subject":"Welcome to Gold, {customer_name} - 5% off to celebrate","body":"Hi {customer_name}, you've earned {tier} status! 5% off your next order. Code: GNEW5.","active":True,"updatedAt":""},
    ...
    {"id":"tpl-010","tier_name":"silver","risk_level":"returning","discount_pct":5,"channel":"email","action_type":"Loyalty Reward","message_template":"Good to see you again, {name} - 5% off.","priority":2,"subject":"Good to see you again, {customer_name} - 5% off","body":"Welcome back, {customer_name}! Enjoy 5% off as a returning {tier} member. Code: SILBACK5.","active":True,"updatedAt":""},
